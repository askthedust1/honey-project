    ...
    <header>
      ...
      <div className={cls.hamburger_menu}>
        ...
        <ul className={cls.menu__box}>
          <li><Link className={cls.menu__item} href={'/'}>{t('home')}</Link></li>
          <li><Link className={cls.menu__item} href={'/products/page/1'}>{t('products')}</Link></li>
          <li><Link className={cls.menu__item} href={'/about'}>{t('about')}</Link></li>
          <li><Link className={cls.menu__item} href={'/delivery'}>{t('delivery')}</Link></li>
          <li><Link className={cls.menu__item} href={'/contacts'}>{t('contacts')}</Link></li>
